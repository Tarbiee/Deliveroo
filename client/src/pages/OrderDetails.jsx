...
function OrderDetails({accessToken}) {
  ...
  const  steps = ['preparing', 'on transit', 'delivered']
            ...
            <div className="flex flex-wrap items-center  justify-center">
                ...
                {steps?.map((step, i) => (
                  ...
                  <div className="absolute hidden top-5 lg:block left-1/2 ">
                      <span
                          className={`mb-3 border-b-2 border-r border-gray-300  w-72 md:block left-1/2  inset-px ${currentStep === i + 1 && "border-blue-600"} ${
                  ...
                  <div className="relative text-center">
                      <span
                          className={`inline-flex items-center justify-center w-10 h-10 mb-8 text-lg text-gray-100 bg-blue-600  ${currentStep === i + 1 && "bg-gray-300"} ${
                            (i + 1 < currentStep || complete)
                          } rounded-full shadow-md `}>
                         { i + 1 < currentStep || complete  ?  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
