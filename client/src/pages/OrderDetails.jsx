      ...
      <div className="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
        <div className="justify-center flex-1 max-w-6xl py-20 mx-auto bg-white   rounded-2xl">
          ...
          <div className="flex flex-wrap items-center  justify-center space-x-10">
               ...
               {status === ( "Delivered") ? ( <div className="relative w-full px-4 mb-16 md:w-1/2 lg:w-1/4 lg:mb-0">
                    <div className="absolute hidden top-5 lg:block left-1/2 ">
                        <span
                            className="mb-3 border-b-2 border-r border-blue-600 w-72 md:block left-1/2  inset-px">
                        </span>
                ...
                </div>) : status === ( "In Transit") ? ( <div className="relative w-full px-4 mb-16 md:w-1/2 lg:w-1/4 lg:mb-0">
                    <div className="absolute hidden top-5 lg:block left-1/2 ">
                        <span
                            className="mb-3 border-b-2 border-r border-blue-600 w-72 md:block left-1/2  inset-px">
                        </span>
                ...
                </div>): ( <div className="relative w-full px-4 mb-16 md:w-1/2 lg:w-1/4 lg:mb-0">
                    <div className="absolute hidden top-5 lg:block left-1/2 ">
                        <span
              ...
              { status === "Delivered" ? (<div className="relative w-full px-4 mb-16 md:w-1/2 lg:w-1/4 lg:mb-0">
                    <div className="absolute hidden top-5 lg:block left-1/2 ">
                        <span
                            className="mb-3 border-b-2 border-r  md:block left-1/2  inset-px">
                        </span>
                    </div>
                    <div className="relative text-center">
                        <span
                ...
                </div>):(  <div className="relative w-full px-4 mb-16 md:w-1/2 lg:w-1/4 md:mb-0">
                    <div className="absolute hidden top-5 lg:block left-1/2 ">
